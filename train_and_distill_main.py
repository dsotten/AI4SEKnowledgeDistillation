...
model = SetFitModel.from_pretrained("sentence-transformers/all-mpnet-base-v2").to(device)
...
model = SetFitModel.from_pretrained("sentence-transformers/all-MiniLM-L12-v2").to(device)
